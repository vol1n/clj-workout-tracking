...
function Oo(a,b,c,d){var e=xl.sync(b,{nothrow:!0});if(Fa(e))throw Sh(["Executable '",A.g(b),"' not found on system path."].join(""),new v(null,2,[Ri,b,dj,c],null));a=mh(vg.m(R([new v(null,3,[Yk,a,Ai,"inherit",Ji,wp(e)],null),d])));return ul.spawnSync(e,Ka(c),a)}
