...
ajax.url.key_value_pair_to_str = (function ajax$url$key_value_pair_to_str(p__27594){
...
var vec_key_encode = (function (){var G__27601 = (function (){var or__5045__auto__ = vec_strategy;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__27601__$1)].join('')));
 ...
 */
ajax.url.param_to_key_value_pairs = (function ajax$url$param_to_key_value_pairs(vec_key_transform,prefix,p__27602){
var vec__27604 = p__27602;
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27604,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27604,(1),null);
...
(ajax.url.url_request_format.cljs$core$IFn$_invoke$arity$1 = (function (p__27611){
var map__27612 = p__27611;
var map__27612__$1 = cljs.core.__destructure_map(map__27612);
var vec_strategy = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27612__$1,new cljs.core.Keyword(null,"vec-strategy","vec-strategy",1843221372));
