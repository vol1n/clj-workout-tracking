...
var G__27786 = request;
var G__27787 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__27786,G__27787) : ajax.formats.get_format.call(null,G__27786,G__27787));
} else {
...
return cljs.core.some((function (p1__27793_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__27793_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__27794){
var map__27795 = p__27794;
var map__27795__$1 = cljs.core.__destructure_map(map__27795);
var request = map__27795__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27795__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__27806 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__27806.cljs$core$IFn$_invoke$arity$1 ? fexpr__27806.cljs$core$IFn$_invoke$arity$1(response) : fexpr__27806.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__27808){
var map__27809 = p__27808;
var map__27809__$1 = cljs.core.__destructure_map(map__27809);
var request = map__27809__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27809__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__27807_SHARP_){
return ajax.formats.get_accept_entries(request,p1__27807_SHARP_);
