...
var G__27790 = o;
reagent.impl.template.goog$module$goog$object.set(G__27790,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__27808__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__27808 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__27809__i = 0, G__27809__a = new Array(arguments.length -  0);
while (G__27809__i < G__27809__a.length) {G__27809__a[G__27809__i] = arguments[G__27809__i + 0]; ++G__27809__i;}
  args = new cljs.core.IndexedSeq(G__27809__a,0,null);
} 
return G__27808__delegate.call(this,args);};
G__27808.cljs$lang$maxFixedArity = 0;
G__27808.cljs$lang$applyTo = (function (arglist__27810){
var args = cljs.core.seq(arglist__27810);
return G__27808__delegate(args);
});
...
var G__27791 = o;
reagent.impl.template.goog$module$goog$object.set(G__27791,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__27811__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__27811 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__27812__i = 0, G__27812__a = new Array(arguments.length -  0);
while (G__27812__i < G__27812__a.length) {G__27812__a[G__27812__i] = arguments[G__27812__i + 0]; ++G__27812__i;}
  args = new cljs.core.IndexedSeq(G__27812__a,0,null);
} 
return G__27811__delegate.call(this,args);};
G__27811.cljs$lang$maxFixedArity = 0;
G__27811.cljs$lang$applyTo = (function (arglist__27813){
var args = cljs.core.seq(arglist__27813);
return G__27811__delegate(args);
});
G__27811.cljs$core$IFn$_invoke$arity$variadic = G__27811__delegate;
return G__27811;
})()
;
} else {
...
var G__27792 = props;
var G__27792__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__27792,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__27792);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__27792__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__27793 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__27793,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__27793;
}
})(),id_class);
...
var G__27794 = (cljs.core.count(argv) - first_child);
switch (G__27794) {
case (0):
...
var vec__27795 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27795,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27795,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27795,(2),null);
...
var temp__5808__auto___27817 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___27817 == null)){
} else {
var key_27818 = temp__5808__auto___27817;
(jsprops.key = key_27818);
}
...
var temp__5808__auto___27820 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___27820 == null)){
} else {
var key_27822 = temp__5808__auto___27820;
(jsprops.key = key_27822);
}
...
var temp__5808__auto___27825 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___27825 == null)){
} else {
var key_27826 = temp__5808__auto___27825;
(jsprops.key = key_27826);
}
...
var temp__5808__auto___27831 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___27831 == null)){
} else {
var key_27832 = temp__5808__auto___27831;
(jsprops.key = key_27832);
}
...
var temp__5808__auto___27834 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___27834 == null)){
} else {
var key_27837 = temp__5808__auto___27834;
(jsprops.key = key_27837);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27798_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__27798_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__27799 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27799,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27799,(1),null);
...
break;
default:
var G__27846 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__27847 = compiler;
v = G__27846;
compiler = G__27847;
continue;
...
var G__27803 = tag;
var G__27803__$1 = (((G__27803 instanceof cljs.core.Keyword))?G__27803.fqn:null);
switch (G__27803__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template27805 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template27805 = (function (opts,id,fn_to_element,parse_fn,meta27806){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template27805.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_27807,meta27806__$1){
var self__ = this;
var _27807__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template27805(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta27806__$1));
}));

(reagent.impl.template.t_reagent$impl$template27805.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_27807){
var self__ = this;
var _27807__$1 = this;
return self__.meta27806;
}));

(reagent.impl.template.t_reagent$impl$template27805.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template27805.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template27805.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template27805.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template27805.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template27805.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta27806","meta27806",1338367866,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template27805.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template27805.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template27805");

(reagent.impl.template.t_reagent$impl$template27805.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template27805");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template27805.
 */
reagent.impl.template.__GT_t_reagent$impl$template27805 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template27805(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta27806){
return (new reagent.impl.template.t_reagent$impl$template27805(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta27806));
});

}

return (new reagent.impl.template.t_reagent$impl$template27805(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
